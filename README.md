...
[![CircleCI](https://circleci.com/gh/bradleyjkemp/osquery-go/tree/master.svg?style=svg)](https://circleci.com/gh/bradleyjkemp/osquery-go/tree/master)
[![GoDoc](https://godoc.org/github.com/bradleyjkemp/osquery-go?status.svg)](http://godoc.org/github.com/bradleyjkemp/osquery-go)
...
git clone git@github.com:bradleyjkemp/osquery-go.git $GOPATH/src/github.com/bradleyjkemp/osquery-go
cd $GOPATH/src/github.com/bradleyjkemp/osquery-go
make deps
```
